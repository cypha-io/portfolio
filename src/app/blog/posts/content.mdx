...
`const home = {
    label: "Home",
    title: "Chamba Nanang's Portfolio",
    description: "Portfolio website showcasing my work as a Software Engineer and Techpreneur",
    headline: <>Software engineer and techpreneur</>,
    subline: (
      <>
        I'm Chamba, a software engineer and techpreneur, founder and CEO of <InlineCode>SwapGPA</InlineCode>, where I build innovative
        <br /> solutions. After hours, I continue to innovate and create.
      </>
    ),
};`,
    language: "tsx",
